...
- **Denegación por Defecto (Drop All):** La regla final garantiza que cualquier tráfico no explícitamente permitido sea descartado silenciosamente, cumpliendo el requisito arquitectónico de *Default Deny*.
